...
Latest complete local gate on 2026-08-20: **PASS** — development/production builds and health, Alembic `20260820_04`, Ruff/mypy, backend 21/21 with no warning and 92.33% application coverage, frontend 10/10 plus build, Chromium Playwright 2/2, smoke 9/9 with cleanup, and performance 200/200 (p95 124.74 ms against a 1,000 ms threshold). Versionable evidence is indexed in [`docs/INDEX.md`](docs/INDEX.md); attach the run to the final commit hash and confirm it in CI.
