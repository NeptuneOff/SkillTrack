...
| BC01-C5 | Rechercher systématiquement erreurs et dysfonctionnements afin de livrer un logiciel déverminé | plan et jeux de tests, registre de bugs, CI, non-régressions | `docs/annexes/I_tests_recette.md` §§2–6 ; backend 20/20 et 92,36 % ; frontend 10/10 ; E2E jury + accessibilité ; `R_doutes_bugs.md`; CI | 🟢 **Démontré** — stratégie, cas réels, tests et automatisation ; limites de recette explicites |
...
| BC03-C7 | Préparer des jeux d'essai couvrant les possibilités pour livrer sans anomalie logique/fonctionnelle | plan, données nominales/limites/erreurs, exécution | `docs/annexes/I_tests_recette.md` §§2–5 ; backend 20/20 (92,36 %), frontend 10/10, Playwright jury + accessibilité, sample CSV et CI | 🟢 **Démontré dans le périmètre MVP** — recette humaine reste distincte |
